    ...
    function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
        ...
        */
        if ( class_exists( 'RevSlider' ) ) {
            $wbc_sliders_array = array(
                'Main Home' => array( 'mt-xgym-slider-about.zip', 'mt-xgym-slider-personal-trainer.zip', 'mt-xgym-slider-shop.zip', 'mt_xgym_home_01.zip'),
                'Home KickBoxing' => array( 'mt-xgym-slider-about.zip','mt-xgym-slider-kickboxing.zip', 'mt-xgym-slider-shop.zip'),
                'Home Personal Trainer' => array( 'concept1.zip', 'mt-xgym-slider-about.zip', 'mt-xgym-slider-personal-trainer.zip', 'mt-xgym-slider-shop.zip' ),
            );
        ...
        *************************************************************************/
        ...
        if ( isset( $demo_active_import[$current_key]['directory'] ) && !empty( $demo_active_import[$current_key]['directory'] ) && in_array( $demo_active_import[$current_key]['directory'], $wbc_menu_array ) ) {
            $top_menu = get_term_by( 'name', '01 - Main Menu', 'nav_menu' );
        ...
        */
        ...
        $wbc_home_pages = array(
            'Main Home'   => 'Main Home',
            'Home KickBoxing'   => 'Home KickBoxing',
            'Home Personal Trainer'   => 'Home Personal Trainer',
        );
