...
$line_icons_font_i = array(
      ...
      */
      // $meta_boxes['jobs_metaboxs'] = array(
      //       'id'         => 'jobs_metaboxs',
      //       'title'      => __( 'MT Jobs Custom Options', 'modeltheme' ),
      //       'pages'      => array( 'mt_job' ), // Post type
      //       'context'    => 'normal',
      //       'priority'   => 'high',
      ...
      //             ),
      //             array(
      //                   'name'       => __( 'Spaces Available', 'modeltheme' ),
      //                   'desc'       => __( 'Eg: 3', 'modeltheme' ),
      //                   'id'         => 'mt_job_spaces_available',
      //                   'type'       => 'text',
      //             ),
      //             array(
      //                   'name'       => __( 'Location', 'modeltheme' ),
      //                   'desc'       => __( 'Eg: London', 'modeltheme' ),
      //                   'id'         => 'mt_job_location',
      //                   'type'       => 'text',
      //             ),
      //             array(
      //                   'name'       => __( 'Company Name', 'modeltheme' ),
      //                   'desc'       => __( 'Eg: Thecon', 'modeltheme' ),
      //                   'id'         => 'mt_job_company_name',
      //                   'type'       => 'text',
      //             ),
      //             array(
      //                   'name'       => __( 'Listing Expiry Date', 'modeltheme' ),
      //                   'id'         => 'mt_job_listing_expiry_date',
      //                   'type'       => 'text_date',
      //                   'default'    => '06/20/2016'
      //             )
      //       ),
      ...
      $meta_boxes['page_metaboxs'] = array(
            ...
            'fields'     => array(
                  ...
                  */
                  ...
                  // ),
                  // array(
                  //       'name'    => __( 'Comments Status', 'modeltheme' ),
                  //       'id'      => 'comments_on_off',
                  //       'type'    => 'select',
                  //       'options' => array(
                  //             'yes' => __( 'On - Show comments', 'modeltheme' ),
                  //             'no' => __( 'Off - Hide comments', 'modeltheme' )
                  //       ),
                  //       'default' => 'yes',
                  // ),
                  array(
