...
function mt_shortcode_members01($params, $content) {
    ...
    $html .= '<script>
        ...
        $html .= '<div class="mt_members1 '.$class_slider.' owl-carousel row owl-theme animateIn wow '.$animation.'">';
        $args_members = array(
                                ...
                                <div class="members_img_holder">
                                    ...
                                    <div class="member01-content">
                                        <div class="member01-content-inside">
                                            ...
                                            <h4 class="member01_position">'.$metabox_member_position.'</h4>
                                            <a href="'.$button_link.'" class="member01_button" style="background-color:'.$button_background.';">'.$button_text.'</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
