...
if (!class_exists('xgymwp_address_social_icons')) {
	/* ========= social_icons ===================================== */
	class xgymwp_address_social_icons extends WP_Widget {



	    function __construct() {
	        parent::__construct('xgymwp_address_social_icons', esc_attr__('MT - Contact + Social links', 'xgymwp'),array( 'description' => esc_attr__( 'MT - Contact information + Social icons', 'xgymwp' ), ) );
	    }
	        ...
	        <div class="sidebar-social-networks address-social-links">
	            ...
	            <?php if('on' == $instance['widget_contact_details']) { ?>
	                <div class="contact-details">
	                    <p><i class="icon-home"></i> <?php echo esc_attr(xgymwp_redux('mt_contact_address')); ?></p>
	                    <p><i class="icon-screen-smartphone"></i> <?php echo esc_attr(xgymwp_redux('mt_contact_phone')); ?></p>
	                    <p><i class="icon-envelope-letter"></i> <?php echo esc_attr(xgymwp_redux('mt_contact_email')); ?></p>
	                </div>
	            <?php } ?>
	    ...
	    public function form( $instance ) {
	        ...
	        if ( isset( $instance[ 'widget_title' ] ) ) {
	            ...
	            $widget_title = esc_attr__( 'Social icons', 'xgymwp' );
	        }
	        ?>

	        <p>
	            <label for="<?php echo esc_attr($this->get_field_id( 'widget_title' )); ?>"><?php esc_attr_e( 'Widget Title:','xgymwp' ); ?></label> 
	        ...
	        <p>
	            ...
	            <label for="<?php echo esc_attr($this->get_field_name('widget_contact_details')); ?>"><?php esc_attr_e( 'Show contact informations box','xgymwp' ); ?></label>
	        </p>
	        <p>
	            ...
	            <label for="<?php echo esc_attr($this->get_field_name('widget_social_icons')); ?>"><?php esc_attr_e( 'Show social icons','xgymwp' ); ?></label>
	        </p>
	...
	*/
	        ?>
	        <p><?php esc_attr_e( '* Social Network account must be set from MT - Theme Panel.','xgymwp' ); ?></p>
	        <?php 
	    }
...
if (!class_exists('xgymwp_flickr')) {
	/* ========= Flickr_Feed_Widget ===================================== */
	class xgymwp_flickr extends WP_Widget { 
	    
	    function __construct() {
	        $widget_ops = array('description' => esc_attr__('Display latest Flickr Feed','xgymwp') );
	        $control_ops = array( 'width' => 60, 'height' => 60, 'id_base' => 'flickr' );
	        parent::__construct( 'xgymwp_flickr', esc_attr__('MT - Flickr Feed','xgymwp'), $widget_ops, $control_ops );
	    }
	    ...
	    function form($instance) {
	        ...
	        <p>
	            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_attr_e('Title of the Widget', 'xgymwp'); ?></label>
	            <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" value="<?php echo esc_attr($instance['title']); ?>" />
	        </p>
	        <p>
	            <label for="<?php echo esc_attr($this->get_field_id( 'username' )); ?>"><?php esc_attr_e('Your Flickr ID:', 'xgymwp'); ?></label>
	            <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'username' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'username' )); ?>" value="<?php echo esc_attr($instance['username']); ?>" /><br /><a href="<?php echo esc_url_raw( 'http://idgettr.com/' ); ?>" target="_blank"><?php esc_attr_e('Flickr idGettr','xgymwp'); ?></a>
	        </p>

	        <p>
	            <label for="<?php echo esc_attr($this->get_field_id( 'pics' )); ?>"><?php esc_attr_e('Number of Photos to show:', 'xgymwp'); ?></label>
...
if (!class_exists('xgymwp_recent_entries_with_thumbnail')) {
	/* ========= xgymwp_recent_entries_with_thumbnail ===================================== */
	class xgymwp_recent_entries_with_thumbnail extends WP_Widget {

	    /**
	     * Register widget with WordPress.
	     */
	    function __construct() {
	        parent::__construct('xgymwp_recent_entries_with_thumbnail', esc_attr__('MT - Recent Posts with thumbnails', 'xgymwp'),array( 'description' => esc_attr__( 'MT - Recent Posts with thumbnails', 'xgymwp' ), ) );
	    }
	    ...
	    public function widget( $args, $instance ) {
	        ...
	        foreach ($recentposts as $post) {
	            $thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ),'xgymwp_post_widget_pic100x100' );
	    ...
	    public function form( $instance ) {
	        ...
	        if ( isset( $instance[ 'recent_posts_title' ] ) ) {
	            ...
	            $recent_posts_title = esc_attr__( 'Recent posts', 'xgymwp' );
	        }
	        ...
	        <p>
	            <label for="<?php echo esc_attr($this->get_field_id( 'recent_posts_title' )); ?>"><?php esc_attr_e( 'Widget Title:','xgymwp' ); ?></label> 
	        ...
	        <p>
	            <label for="<?php echo esc_attr($this->get_field_id( 'recent_posts_number' )); ?>"><?php esc_attr_e( 'Number of posts:','xgymwp' ); ?></label> 
...
if (!class_exists('xgymwp_popular_recent_tabs')) {
	/* ========= Tabs Widget ===================================== */
	class xgymwp_popular_recent_tabs extends WP_Widget {

	    /**
	     * Register widget with WordPress.
	     */
	    function __construct() {
	        parent::__construct('xgymwp_popular_recent_tabs', esc_attr__('MT - TABS: Random, Recent posts', 'xgymwp'),array( 'description' => esc_attr__( 'MT - TABS: Random, Recent posts', 'xgymwp' ), ) );
	    }
	            ...
	            $myContent .= '<div class="tab-content">';
	                ...
	                foreach ($popularposts as $post) {
	                    ...
	                    $myContent .= '<div class="recent-post">';
	                        ...
	                        $myContent .= '<div class="post-description">'.xgymwp_excerpt_limit($excerpt,10).'</div>';
	                    $myContent .= '</div>';
	                }
	                $myContent .= '</div>';
	    ...
	    public function form( $instance ) {
	        ...
	        if ( isset( $instance[ 'recent_posts_title' ] ) ) {
	            ...
	            $recent_posts_title = esc_attr__( 'Tab Widget', 'xgymwp' );
	        }
	        ...
	        if ( isset( $instance[ 'title_first_tab' ] ) ) {
	            ...
	            $title_first_tab = esc_attr__( 'Random posts', 'xgymwp' );
	        }
	        # Number of posts
	        ...
	        if ( isset( $instance[ 'title_second_tab' ] ) ) {
	            ...
	            $title_second_tab = esc_attr__( 'Recent posts', 'xgymwp' );
	        }
	        # Number of posts
	        if ( isset( $instance[ 'recent_posts_number' ] ) ) {
	            $recent_posts_number = $instance[ 'recent_posts_number' ];
	        ...
	        <p>
	            <label for="<?php echo esc_attr($this->get_field_id( 'title_first_tab' )); ?>"><?php esc_attr_e( 'Number of recent posts:','xgymwp' ); ?></label> 
	        ...
	        <p>
	            <label for="<?php echo esc_attr($this->get_field_id( 'recent_posts_number' )); ?>"><?php esc_attr_e( 'Number of recent posts:','xgymwp' ); ?></label> 
	            <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'recent_posts_number' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'recent_posts_number' )); ?>" type="text" value="<?php echo esc_attr( $recent_posts_number ); ?>">
	        </p>
	        <p>
	            <label for="<?php echo esc_attr($this->get_field_id( 'title_second_tab' )); ?>"><?php esc_attr_e( 'Number of popular posts:','xgymwp' ); ?></label> 
	        ...
	        <p>
	            <label for="<?php echo esc_attr($this->get_field_id( 'popular_posts_number' )); ?>"><?php esc_attr_e( 'Number of popular posts:','xgymwp' ); ?></label> 
...
if (!class_exists('xgymwp_post_thumbnails_slider')) {
	/* ========= xgymwp_post_thumbnails_slider ===================================== */
	class xgymwp_post_thumbnails_slider extends WP_Widget {

	    /**
	     * Register widget with WordPress.
	     */
	    function __construct() {
	        parent::__construct('xgymwp_post_thumbnails_slider', esc_attr__('MT - Post thumbnails slider', 'xgymwp'),array( 'description' => esc_attr__( 'MT - Post thumbnails slider', 'xgymwp' ), ) );
	    }
	    ...
	    public function form( $instance ) {
	        ...
	        if ( isset( $instance[ 'recent_posts_title' ] ) ) {
	            ...
	            $recent_posts_title = esc_attr__( 'Post thumbnails slider', 'xgymwp' );
	        }
...
if (!class_exists('xgymwp_social_share')) {
	/* ========= xgymwp_social_share ===================================== */
	class xgymwp_social_share extends WP_Widget {



	    function __construct() {
	        parent::__construct('xgymwp_social_share', esc_attr__('MT - Social Share Icons', 'xgymwp'),array( 'description' => esc_attr__( 'MT - Social Share Icons', 'xgymwp' ), ) );
	    }
	        ...
	        <div class="sidebar-share-social-links">
	            ...
	            <ul class="share-social-links">
	                ...
	                <li class="pinterest">
	                    ...
	                    <?php /*<a href="http://pinterest.com/pin/create/button/?url=<?php echo esc_attr($siteurl); ?>&amp;media=<?php echo esc_attr(xgymwp_redux('mt_logo', 'url')); ?>&amp;description=<?php echo esc_attr($sitedescription); ?>" target="_blank"><i class="fa fa-pinterest"></i></a>*/ ?>
	                </li>
	    ...
	    public function form( $instance ) {
	        ...
	        <p><?php esc_attr_e( 'Check what Social SHARE Buttons do you want to display','xgymwp' ); ?></p>
	        <p>
	            ...
	            <label for="<?php echo esc_attr($this->get_field_name('share-facebook')); ?>"><?php esc_attr_e( 'Facebook','xgymwp' ); ?></label>
	        </p>
	        <p>
	            ...
	            <label for="<?php echo esc_attr($this->get_field_name('share-twitter')); ?>"><?php esc_attr_e( 'Twitter','xgymwp' ); ?></label>
	        </p>
	        <p>
	            ...
	            <label for="<?php echo esc_attr($this->get_field_name('share-linkedin')); ?>"><?php esc_attr_e( 'Linkedin','xgymwp' ); ?></label>
	        </p>
	        <p>
	            ...
	            <label for="<?php echo esc_attr($this->get_field_name('share-googleplus')); ?>"><?php esc_attr_e( 'Google Plus','xgymwp' ); ?></label>
	        </p>
	        <p>
	            ...
	            <label for="<?php echo esc_attr($this->get_field_name('share-digg')); ?>"><?php esc_attr_e( 'Digg','xgymwp' ); ?></label>
	        </p>
	        <p>
	            ...
	            <label for="<?php echo esc_attr($this->get_field_name('share-pinterest')); ?>"><?php esc_attr_e( 'Pinterest','xgymwp' ); ?></label>
	        </p>
	        <p>
	            ...
	            <label for="<?php echo esc_attr($this->get_field_name('share-reddit')); ?>"><?php esc_attr_e( 'Reddit','xgymwp' ); ?></label>
	        </p>
	        <p>
	            ...
	            <label for="<?php echo esc_attr($this->get_field_name('share-stumbleupon')); ?>"><?php esc_attr_e( 'Stumbleupon','xgymwp' ); ?></label>
	        </p>
...
// Register Widgets
if (!function_exists('xgymwp_register_widgets')) {
	function xgymwp_register_widgets() {
	    register_widget( 'xgymwp_address_social_icons' );
	    register_widget( 'xgymwp_social_share' );
	    register_widget( 'xgymwp_flickr' );
	    register_widget( 'xgymwp_recent_entries_with_thumbnail' );
	    register_widget( 'xgymwp_post_thumbnails_slider' );
	    register_widget( 'xgymwp_popular_recent_tabs' );

	}
	add_action( 'widgets_init', 'xgymwp_register_widgets' );
}
