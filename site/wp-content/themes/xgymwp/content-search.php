...
$thumbnail_src      = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'xgymwp_related_post_pic500x300' );
...
<article id="post-<?php the_ID(); ?>" <?php post_class('row single-post'); ?>>
    ...
    <div class="col-md-8 post-details">
        ...
        <div class="post-category-comment-date row">
            <span class="post-author"><?php echo esc_attr__('by ', 'xgymwp') . get_the_author(); ?></span>   /   
        ...
        <?php
            ...
            the_content( sprintf(
                esc_html__( 'Continue reading ', 'xgymwp' ) . '%s <span class="meta-nav">&rarr;</span>',
