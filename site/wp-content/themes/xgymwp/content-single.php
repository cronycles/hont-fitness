...
if ( function_exists('modeltheme_framework')) {
    if (isset($select_post_sidebar) && $select_post_sidebar != '') {
        ...
        $sidebar = xgymwp_redux('mt_single_blog_layout_sidebar');
    }
}
...
if (isset($select_post_layout) && in_array($select_post_layout, $sidebars_lr_meta)) {
    ...
    if(class_exists( 'ReduxFrameworkPlugin' )){
        ...
        if (in_array(xgymwp_redux('mt_single_blog_layout'), $sidebars_lr_panel)) {
...
if ( function_exists('modeltheme_framework')) {
    if (isset($breadcrumbs_on_off) && $breadcrumbs_on_off == 'yes' || $breadcrumbs_on_off == '') {
        echo xgymwp_header_title_breadcrumbs();
    }else{
    }
}else{
    echo xgymwp_header_title_breadcrumbs();
       ...
       <div class="row">
            ...
            <?php }else{ ?>
                <?php if (isset($select_post_layout) && $select_post_layout == 'inherit') { ?>
                    <?php if(class_exists( 'ReduxFrameworkPlugin' )){ ?>
                        <?php if ( xgymwp_redux('mt_single_blog_layout') == 'mt_single_blog_left_sidebar') { ?>
                            <div class="col-md-4 col-sm-4 sidebar-content sidebar-left">
                                <?php if (is_active_sidebar($sidebar)) { ?>
                                    <?php dynamic_sidebar($sidebar); ?>
                                <?php } ?>
            ...
            <div class="<?php echo esc_attr($cols); ?> main-content">
                ...
                <div class="article-header">
                    <div class="article-details">
                        ...
                        <?php $thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ),'xgymwp_1150x400' ); 
                        if($thumbnail_src) { ?>
                            <?php the_post_thumbnail( 'xgymwp_1150x400' ); ?>
                        <?php } ?>
                ...
                <div class="article-content">
                    ...
                    <?php if (get_the_tags()) { ?>
                        <div class="single-post-tags">
                            <span><?php echo esc_html__('Tags:','xgymwp'); ?></span> <?php echo get_the_term_list( get_the_ID(), 'post_tag', '', ' ' ); ?>
                        </div>
                    <?php } ?>
                    ...
                    <!-- AUTHOR BIO -->
                    <?php if ( xgymwp_redux('mt_enable_authorbio') ) { ?>
                            ...
                            <div class="author-thumbnail col-md-4">
                                ...
                                <div class="pull-left">
                                    <div class="author-name">
                                        <span><?php echo esc_html__('Written by','xgymwp'); ?></span>
            ...
            <?php if(class_exists( 'ReduxFrameworkPlugin' )){ ?>
                ...
                <?php }elseif(isset($select_post_layout) && $select_post_layout == 'inherit') { ?>
                    <?php if ( xgymwp_redux('mt_single_blog_layout') == 'mt_single_blog_right_sidebar') { ?>
                        <div class="col-md-4 sidebar-content sidebar-right">
                            <?php if (is_active_sidebar($sidebar)) { ?>
                                <?php dynamic_sidebar($sidebar); ?>
                            <?php } ?>
...
<div class="row post-details-bottom">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php if ( xgymwp_redux('mt_enable_related_posts') ) { ?>
                ...
                <div class="related-posts sticky-posts">
                    ...
                    <?php if ($tags) { ?>
                    <h2 class="heading-bottom"><?php esc_attr_e('Related Posts', 'xgymwp'); ?></h2>
                    <div class="row">
                        <?php $tag_ids = array();  
                            ...
                            <div class="col-md-4 post">
                                <div class="related_blog_custom">
                                    ...
                                    <div class="related_blog_details">
                                        ...
                                        <div class="post-author"><?php echo esc_attr('Posted by ','xgymwp'); ?><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) ); ?>"><?php echo get_the_author(); ?></a> - <?php echo get_the_date( 'j M' ); ?></div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="clearfix"></div> 
                <?php if ( xgymwp_redux('mt_enable_post_navigation') ) { ?>
