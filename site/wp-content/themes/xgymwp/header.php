...
<head>
    ...
    <?php if ( ! function_exists( 'has_site_icon' ) || ! has_site_icon() ) { ?>
        <link rel="shortcut icon" href="<?php echo esc_url(xgymwp_redux('mt_favicon', 'url')); ?>">
    <?php } ?>
    <?php wp_head(); ?>
</head>
...
<body <?php body_class(); ?>>
    ...
    <?php
        ...
        if (xgymwp_redux('mt_preloader_status')) {
            echo  '<div class="xgymwp_preloader_holder '.xgymwp_redux('mt_preloader_animation').'">'.xgymwp_loader_animation().'</div>';
        } 
    ...
    $header_layout = xgymwp_redux('mt_header_layout');
    ...
    <div class="fixed-search-overlay">
        ...
        <div class="fixed-search-inside">
            <?php echo xgymwp_custom_search_form(); ?>
        </div>
    </div>
    <?php } ?>
            ...
            <div class="fixed-sidebar-menu">
                ...
                <div class="header7">
                    ...
                    <div class="left-side">
                        ...
                        <?php if (is_active_sidebar( xgymwp_redux('mt_header_fixed_sidebar') )) {
                            dynamic_sidebar( xgymwp_redux('mt_header_fixed_sidebar') ); 
                        } ?>
                    </div>
                </div>
            </div>
    ...
    <div id="page" class="hfeed site">
        <?php
            ...
            if (in_array($header_layout, $below_slider_headers)){
                ...
                echo xgymwp_current_header_template();
