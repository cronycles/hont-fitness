<?php
	...
	*/
    ...
    function xgymwp_loader_animation(){

        global  $xgymwp_redux;
        
        $html = '';

        if (isset($xgymwp_redux['mt_preloader_animation'])) {
            if ($xgymwp_redux['mt_preloader_animation'] == 'v1_ball_triangle') {
                $html .= '<div class="xgymwp_preloader v1_ball_triangle">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v2_ball_pulse'){
                $html .= '<div class="xgymwp_preloader v2_ball_pulse">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v3_ball_grid_pulse'){
                $html .= '<div class="xgymwp_preloader v3_ball_grid_pulse">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v4_ball_clip_rotate'){
                $html .= '<div class="xgymwp_preloader v4_ball_clip_rotate">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v5_ball_clip_rotate_pulse'){
                $html .= '<div class="xgymwp_preloader v5_ball_clip_rotate_pulse">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v6_square_spin'){
                $html .= '<div class="xgymwp_preloader v6_square_spin">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v7_ball_clip_rotate_multiple'){
                $html .= '<div class="xgymwp_preloader v7_ball_clip_rotate_multiple">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v8_ball_pulse_rise'){
                $html .= '<div class="xgymwp_preloader v8_ball_pulse_rise">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v9_ball_rotate'){
                $html .= '<div class="xgymwp_preloader v9_ball_rotate">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v10_cube_transition'){
                $html .= '<div class="xgymwp_preloader v10_cube_transition">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v11_ball_zig_zag'){
                $html .= '<div class="xgymwp_preloader v11_ball_zig_zag">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v12_ball_zig_zag_deflect'){
                $html .= '<div class="xgymwp_preloader v12_ball_zig_zag_deflect">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v13_ball_scale'){
                $html .= '<div class="xgymwp_preloader v13_ball_scale">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v14_line_scale'){
                $html .= '<div class="xgymwp_preloader v14_line_scale">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v15_line_scale_party'){
                $html .= '<div class="xgymwp_preloader v15_line_scale_party">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v16_ball_scale_multiple'){
                $html .= '<div class="xgymwp_preloader v16_ball_scale_multiple">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v17_ball_pulse_sync'){
                $html .= '<div class="xgymwp_preloader v17_ball_pulse_sync">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v18_ball_beat'){
                $html .= '<div class="xgymwp_preloader v18_ball_beat">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v19_line_scale_pulse_out'){
                $html .= '<div class="xgymwp_preloader v19_line_scale_pulse_out">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($xgymwp_redux['mt_preloader_animation'] == 'v20_line_scale_pulse_out_rapid'){
                $html .= '<div class="xgymwp_preloader v20_line_scale_pulse_out_rapid">
                            <div class="loaders">
                                <div class="loader">
	...
	/**
	Function name: 				xgymwp_footer_row1()
	Function description:		Footer row 1
	*/
	function xgymwp_footer_row1(){
		...
		global  $xgymwp_redux;
            ...
            echo '<div class="row">';
                echo '<div class="col-md-12 footer-row-1">';
                    ...
                    $footer_row_1_layout = $xgymwp_redux['mt_footer_row_1_layout'];
                    $nr = array("1", "2", "3", "4", "6");
                    ...
                    if (in_array($footer_row_1_layout, $nr)) {
                        ...
                        for ( $i=1; $i <= $footer_row_1_layout ; $i++ ) { 
                            if ( is_active_sidebar( 'footer_row_1_'.$i ) ){
    ...
    /**
    Function name:              xgymwp_footer_row2()
    Function description:       Footer row 2
    */
    function xgymwp_footer_row2(){
        ...
        global  $xgymwp_redux;
            ...
            echo '<div class="row">';
                echo '<div class="col-md-12 footer-row-2">';
                    ...
                    $footer_row_2_layout = $xgymwp_redux['mt_footer_row_2_layout'];
                    $nr = array("1", "2", "3", "4", "6");
                    ...
                    if (in_array($footer_row_2_layout, $nr)) {
                        ...
                        for ( $i=1; $i <= $footer_row_2_layout ; $i++ ) { 
                            if ( is_active_sidebar( 'footer_row_2_'.$i ) ){
                                echo '<div class="'.$class.' sidebar-'.$i.'">';
    ...
    /**
    Function name:              xgymwp_footer_row3()
    Function description:       Footer row 3
    */
    function xgymwp_footer_row3(){
        ...
        global  $xgymwp_redux;
            ...
            echo '<div class="row">';
                echo '<div class="col-md-12 footer-row-3">';
                    ...
                    $footer_row_3_layout = $xgymwp_redux['mt_footer_row_3_layout'];
                    $nr = array("1", "2", "3", "4", "6");
                    ...
                    if (in_array($footer_row_3_layout, $nr)) {
                        ...
                        for ( $i=1; $i <= $footer_row_3_layout ; $i++ ) { 
                            if ( is_active_sidebar( 'footer_row_3_'.$i ) ){
                                echo '<div class="'.$class.' sidebar-'.$i.'">';
