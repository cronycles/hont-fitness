...
add_action( 'tgmpa_register', 'xgymwp_register_plugins' );
 ...
 */
function xgymwp_register_plugins() {
    /*
    ...
    $plugins = array(
        ...
        array(
            'name'                  => esc_html__('WPBakery Page Builder', 'xgymwp'), // The plugin name
            'slug'                  => 'js_composer', // The plugin slug (typically the folder name)
            'source'                => esc_url('http://modeltheme.com/TFPLUGINS/js_composer5.zip'), // The plugin source
        ...
        array(
            'name'                  => esc_html__('Revolution Slider', 'xgymwp'), // The plugin name
        ...
        array(
            'name'                  => esc_html__('Essential Grids', 'xgymwp'), // The plugin name
        ...
        array(
            'name'                  => esc_html__('Parallax Backgrounds for VC', 'xgymwp'), // The plugin name
        ...
        array(
            'name'                  => esc_html__('ModelTheme Framework', 'xgymwp'), // The plugin name
            'slug'                  => 'modeltheme-framework', // The plugin slug (typically the folder name)
            'source'                => esc_url('http://modeltheme.com/TFPLUGINS/modeltheme-framework-xgym.zip'), // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            'name'                  => esc_html__('Redux Framework', 'xgymwp'), // The plugin name
            'slug'                  => 'redux-framework', // The plugin slug (typically the folder name)
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ),
        array(
            'name'                  => esc_html__('Timetable and Event Schedule', 'xgymwp'), // The plugin name
            'slug'                  => 'mp-timetable', // The plugin slug (typically the folder name)
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ),
        array(
            'name'                  => esc_html__('WooCommerce', 'xgymwp'), // The plugin name
            'slug'                  => 'woocommerce', // The plugin slug (typically the folder name)
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ),
        array(
            'name'                  => esc_html__('Contact Form 7', 'xgymwp'), // The plugin name
